...
export function Philosophy({ custom_fields }: any) {
  ...
  return (
    <section ref={fourRef} className="py-[30px] sm:py-[50px]">
      <div className="px-[30px] w-full sm:max-w-[85%] mx-auto">
        <div className="bg-blue-3 rounded-[10px] bg-[url('/fabout/target.png')] bg-contain bg-no-repeat bg-right">
          <div className="grid items-center grid-cols-1 md:grid-cols-[70%_30%] mb-8 uppercase px-[20px] li:px-[30px] text-[16px] li:text-[20px] 2xl:text-[35px] py-[2px] text-white">
            <div className="pb-[22px] font-bold text-start leading-[30px] 2xl:leading-[42px] pt-[10px] sm:pl-[106px]">
              <p>{field_19_about}<br /> {field_20_about}</p>
            </div>
            <div className="text-end py-[22px] leading-[30px]  sm:leading-[52px] 2xl:leading-[62px] font-[500]">
      ...
      <div ref={fiveRef} className="px-[30px] w-full sm:max-w-[85%] m-auto">
