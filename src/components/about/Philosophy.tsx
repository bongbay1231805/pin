...
export function Philosophy() {
  return (
    <section className="py-16">
      <div className="container max-w-[83%] mx-auto  bg-blue-3 rounded-[10px] px-[100px] bg-[url('/fabout/target.png')] bg-no-repeat bg-center bg-right">
      ...
      <div className="container max-w-[83%] m-auto px-[10px]">
