...
export function Philosophy({ custom_fields }: any) {
  ...
  return (
    <section ref={fourRef} className="w-full px-[30px] md:px-0 md:max-w-[85%] mx-auto py-[30px] md:py-[50px]">
      <div className="boxanimation bg-blue-3 rounded-[10px] bg-[url('/fabout/target.png')] bg-contain bg-no-repeat bg-right">
        <div className="grid items-center grid-cols-1 md:grid-cols-[30%_70%] mb-8 uppercase text-[16px] li:text-[20px] 2xl:text-[35px] py-[2px] text-white">
          <div className="reveal-text py-[22px] font-bold leading-[30px] sm:leading-[35px] 2xl:leading-[50px] text-[20px] sm:text-[23px] 2xl:text-[35px] 2xl:leading-[42px] px-[30px] sm:px-[106px] pr-[15px] sm:pr-[20px]">
            <p>{field_19_about}<br />{field_20_about}</p>
          </div>
          <div className="reveal-text text-end py-[22px] px-[30px] sm:pr-[106px] text-[20px] sm:text-[23px] 2xl:text-[35px] leading-[30px] sm:leading-[52px] 2xl:leading-[62px] font-[500]">
      ...
      <div ref={fiveRef} className="m-auto boxanimation fade-in-up-medium">
          ...
          <div className="relative vision-item vision-item h-[180px] sm:h-[320px] 2xl:h-[380px] bg-gray-800 group rounded-[10px] overflow-hidden">
            ...
            <div className="absolute vision-content inset-0 flex items-center justify-center">
              <div className="text-center p-6">
                ...
                <div className="text-[14px] 2xl:text-[16px] content text-white pl-[15px] pr-[15px]" dangerouslySetInnerHTML={{ __html: field_22_about }}></div>
          ...
          <div className="relative vision-item h-[180px] sm:h-[320px] 2xl:h-[380px] bg-gray-800 group rounded-[10px] overflow-hidden">
            ...
            <div className="absolute vision-content inset-0 flex items-center justify-center">
              <div className="text-center p-6">
                ...
                <div className="text-[14px] 2xl:text-[16px] content text-white pl-[15px] pr-[15px]" dangerouslySetInnerHTML={{ __html: field_23_about }}></div>
                <div className="bg"></div>
              </div>
            </div>
          </div>
