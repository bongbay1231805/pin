  ...
  return (
    <>
      ...
      <div className="boxanimation fade-in-up-medium grid grid-cols-2 md:grid-cols-4 gap-[10px] sm:gap-[20px] mx-auto w-full px-[30px] xl:max-w-[85%] pb-[45px]">
        ...
        <div className='group border-1 border-gray-8 text-blue-1 hover:[&>svg>path]:fill-white hover:bg-yellow-1 hover:text-white gap-[10px] rounded-2xl flex flex-col h-[160px] sm:h-[218px] 2xl:h-[300px] items-center justify-center'>
          <div className='[&>svg]:w-[50px] [&>svg]:h-[50px] sm:[&>svg]:w-[88px] sm:[&>svg]:h-[88px] transition-transform duration-300 group-hover:scale-110' dangerouslySetInnerHTML={{ __html: human_resource_5 }}></div>
        ...
        <div className='group border-1 border-gray-8 text-blue-1 hover:[&>svg>path]:fill-white hover:bg-yellow-1 hover:text-white gap-[10px] rounded-2xl flex flex-col h-[160px] sm:h-[218px] 2xl:h-[300px] items-center justify-center'>
          <div className='[&>svg]:w-[50px] [&>svg]:h-[50px] sm:[&>svg]:w-[88px] sm:[&>svg]:h-[88px] transition-transform duration-300 group-hover:scale-110' dangerouslySetInnerHTML={{ __html: human_resource_7 }}></div>
        ...
        <div className='group border-1 border-gray-8 text-blue-1 hover:[&>svg>path]:fill-white hover:bg-yellow-1 hover:text-white gap-[10px] rounded-2xl flex flex-col h-[160px] sm:h-[218px] 2xl:h-[300px] items-center justify-center'>
          <div className='[&>svg]:w-[50px] [&>svg]:h-[50px] sm:[&>svg]:w-[88px] sm:[&>svg]:h-[88px] transition-transform duration-300 group-hover:scale-110' dangerouslySetInnerHTML={{ __html: human_resource_9 }}></div>
      ...
      <div>
        ...
        <div className="boxanimation fade-in-up-medium mx-auto w-full px-[30px] xl:max-w-[85%]">
          <h3 className="uppercase font-bold text-yellow-1 text-[22px] sm:text-[28px] 2xl:text-[45px] text-center py-[50px_30px] sm:py-[100px_25px]">
            {human_resource_14}
          </h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-[63%_1fr] sm:grid-rows-2 gap-[5px] sm:gap-[20px]">
            ...
            relative sm:row-span-2 w-full aspect-square sm:aspect-auto sm:h-full group overflow-hidden md:rounded-[10px] after:content-[''] after:absolute after:left-0 after:bottom-0
              ...
              <Image
                className="transition-transform duration-1000 group-hover:scale-[120%] w-full h-full object-cover"
                alt="benefit 8"
                loading="lazy"
                decoding="async"
                width="1900"
              ...
              />
              <div className="absolute uppercase bottom-[20px] w-full text-center text-[18px] sm:text-[17px] text-white font-bold z-10 px-[15px]">
                {human_resource_16}
              </div>
            </div>
