        ...
        <div ref={twoRef}>
          ...
          <div className="mx-auto w-full px-[30px] xl:max-w-[85%]">
            <h3 className="uppercase font-bold text-yellow-1 text-[22px] sm:text-[28px] 2xl:text-[45px] text-center py-[50px_30px] sm:py-[100px_25px]">{human_resource_14}</h3>
              <div className="grid grid-cols-1 sm:grid-cols-[63%_1fr] 2xl:grid-cols-[65%_1fr] grid-rows-3 sm:grid-rows-2 gap-[10px] sm:gap-[20px] sm:h-[385px] 2xl:h-[900px] h-auto">
              ...
              after:opacity-80 hover:after:opacity-100">
                ...
                <div className="absolute uppercase bottom-[20px] w-full text-center text-[14px] sm:text-[17px] 2xl:text-[20px] text-white font-bold object-top z-10" style={{ objectFit: 'cover' }} >{human_resource_16}</div>
              </div>
              ...
              after:opacity-80 hover:after:opacity-100">
                  ...
                  <div className="absolute uppercase bottom-[20px] w-full text-center text-[14px] sm:text-[17px] 2xl:text-[20px] text-white font-bold z-10">{human_resource_18}</div>
                </div>
              ...
              after:opacity-80 hover:after:opacity-100">
                  ...
                  <div className="absolute uppercase bottom-[20px] w-full text-center text-[14px] sm:text-[17px] 2xl:text-[20px] text-white font-bold z-10">{human_resource_20}</div>
                </div>
              </div>
            </div>
          </div>
