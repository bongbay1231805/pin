          ...
          <div className="mx-auto max-w-[90%] md:max-w-[85%] 2xl:max-w-[1058px]">
            <div className="relative mx-auto flex items-center justify-center">
              <div className="text-center max-w-[836px] 2xl:max-w-[1088px]">
                <p className="text-[16px] lg:text-[22px] mt-[7%] 2xl:mt-[71px] text-gray-1 fade-in-left-short">
                  {field_1}
                </p>
                <h2 className="text-[22px] lg:text-[28px] 2xl:text-[45px] font-bold text-yellow-1 mt-[0] mb-[2px] fade-in-left-short">
                  {field_2}
                </h2>
                <p className="text-[16px] lg:text-[22px] mb-[37px] text-gray-1 -mt-[8px] fade-in-left-short">
                  {field_3}
                </p>
                <div
                  className="text-[13px] 2xl:text-[17px] mb-[35px] md:mb-[42px] text-gray-5 leading-[22px] 2xl:leading-[28px] fade-in-left-short"
