  ...
  return (
    <>
      ...
      <div className="boxanimation relative bg-no-repeat bg-position-[0_-75px] bg-size-[20%_60%] xl:bg-size-[15%_75%] lg:bg-size-[10%_60%] 2xl:bg-size-[contain]">
        <svg className='absolute top-[-10%] 2xl:top-[-100px] left-0 -translate-x-1/2 max-w-[28%] h-auto' width="528.46" height="523.07" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 528.46 523.07">
          ...
          <div className="mx-auto max-w-[90%] md:max-w-[85%] 2xl:max-w-[1058px]">
            <div className="relative mx-auto flex items-center justify-center">
              <div className="text-center max-w-[836px] 2xl:max-w-[1088px]">
                ...
                <h2 className="text-[22px] xl:text-[28px] 2xl:text-[45px] font-bold text-yellow-1 mt-[0] mb-[2px] fade-in-left-short">{field_2}</h2>
