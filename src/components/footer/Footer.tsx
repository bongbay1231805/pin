            ...
            <div className='mt-0 fade-in-left-short mb-4 md:mb-0'>
              ...
              <ul className="text-[13px] 2xl:text-[17px] text-gray-6">
                <li className="flex items-center">
                  <svg className='mr-[5px]' width="24" height="24" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li className="flex items-center">
                  <svg className='mr-[8px]' width="21" height="21" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
