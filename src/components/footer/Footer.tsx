...
export function Footer() {
  ...
  return (
    <footer className={`bg-gray-3 text-white text-left`}>
      <div className={`pt-[68px] 2xl:pt-[80px] ${styles.bgfooter}`}>
        <div className={`mx-auto max-w-[95%] md:max-w-[85%]  2xl:max-w-[1580px]`}>
          <div className="grid grid-cols-1 sm:grid-cols-[20.5%_1fr_21.5%] 2xl:grid-cols-[340px_1fr_370px] gap-8 boxanimation">
            <div className="flex justify-center sm:justify-normal reveal-tex fade-in-left-short">
              <Link href="/" className="flex-shrink-0 flex">
                <Image src="/logo-c.svg" className='w-[136px] h-[136px] 2xl:w-[166px] 2xl:h-[166px]' width={180} height={180} alt="Logo" />
              </Link>
            </div>
            <div className='mt-[0] fade-in-left-short'>
              <h3 className="text-[17px] 2xl:text-[20px] font-bold mb-[10px] 2xl:mb-[20px] text-gray-4">TẬP ĐOÀN PI GROUP</h3>
              <ul className="text-[14px] 2xl:text-[17px] text-gray-6">
                <li className="flex items-center">
                  <svg className='mr-[5px]' width="25" height="25" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li className="flex items-center">
                  <svg className='mr-[11px]' width="22" height="22" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='2xl:leading-[30px] sm:pl-[30px]'>
              <ul className="space-y-2 text-gray-6 uppercase fade-in-left-short">
                ...
                <li><Link href="/#" className="hover:text-yellow-1  text-gray-6 font-semibold text-[15px] 2xl:text-[17px]">Đô thị số Picity</Link></li>
                <li><Link href="/#" className="hover:text-yellow-1  text-gray-6 font-semibold text-[15px] 2xl:text-[17px]">Tin Tức</Link></li>
                <li><Link href="/#" className="hover:text-yellow-1  text-gray-6 font-semibold text-[15px] 2xl:text-[17px]">Phát Triển Nhân Lực</Link></li>
                <li><Link href="/#" className="hover:text-yellow-1  text-gray-6 font-semibold text-[15px] 2xl:text-[17px]">Liên Hệ</Link></li>
              </ul>
            </div>
          </div>
        </div>
