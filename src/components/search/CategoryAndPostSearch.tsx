...
const CategoryAndPostSearch: React.FC = () => {
  ...
  return (
    <div className='absolute top-1/2 -translate-y-1/2 right-0 max-[400px] m-auto'>
      ...
      {showSearchBlock && (
        <div className='absolute w-[400px] right-0 to-[30px] border-[1px] border-solid border-[#ccc] rounded-[8px] p-[15px] bg-[#f9f9f9]'>
          {/* Dropdown để chọn chuyên mục */}
          <div style={{ marginBottom: '15px' }}>
            <label htmlFor="category-select" className='block mb-[5px] font-bold text-[16px]'>Chọn Chuyên mục:</label>
          ...
          {selectedCategorySlug ? (
            ...
            <p style={{ textAlign: 'center', color: '#777', fontSize: '0.9em' }}>Vui lòng chọn một chuyên mục để tìm kiếm bài viết.</p>
          )}
        </div>
      )}
    </div>
