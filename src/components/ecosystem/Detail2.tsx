      ...
      <div className="mx-auto max-w-[85%] mb-[20%] sm:mb-[5%] 2xl:mb-[203px]">
        ...
        <div>
          ...
          <div className="flex overflow-x-scroll md:overflow-x-visible  md:grid md:grid-cols-3">
            ...
            before:bg-center
            ">
              <svg width="80" height="80" viewBox="0 0 110 111" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M96.5 13.5H103.023C104.523 13.3333 107.523 14 107.523 18V81.5C107.523 89.5 101.023 89 101.023 89H8.02294C6.02294 89.3333 2.02294 89 2.02294 85V18.5C1.85627 16.8333 2.52294 13.5 6.52294 13.5H15.5" stroke="#4C73A8" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M2.52344 74H26.0234" stroke="#4C73A8" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M38.5234 74H107.523" stroke="#4C73A8" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M11.0234 73.5V23.5H39.0234M72.5234 23.5H98.0234V73.5" stroke="#4C73A8" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M22.5234 109H84.5234" stroke="#4C73A8" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M63.5234 89L71.5234 109" stroke="#4C73A8" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M43.5234 89L35.5234 109" stroke="#4C73A8" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M19.0234 50.5H44.0234" stroke="#4C73A8" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M19.0234 58H44.0234" stroke="#4C73A8" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M20 65H81" stroke="#4C73A8" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M61.5234 39V30.5V27.5C61.5234 24.4624 59.061 22 56.0234 22V22C52.9859 22 50.5234 24.4624 50.5234 27.5V30.5V39" stroke="#4C73A8" strokeWidth="2.5" />
                <circle cx="53.0234" cy="80.5" r="1.25" stroke="#4C73A8" strokeWidth="2.5" />
                <path d="M88.5234 40H84.5234V44H80.5234V49.5H86.5234V54H83.0234" stroke="#4C73A8" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
            ...
            <div className="grow-1 relative flex-shrink-0 w-[95%] md:w-auto flex  flex-col justify-center items-center gap-[50px]">
              <svg width="80" height="80" viewBox="0 0 114 114" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M33 23V15C33 13.3431 34.3431 12 36 12H99C100.657 12 102 13.3431 102 15V97C102 98.6569 100.657 100 99 100H91.5" stroke="#4C73A8" strokeWidth="2.5" strokeLinejoin="round" />
                <path d="M43 13V5C43 3.34315 44.3431 2 46 2H109C110.657 2 112 3.34315 112 5V87C112 88.6569 110.657 90 109 90H101.5" stroke="#4C73A8" strokeWidth="2.5" strokeLinejoin="round" />
                ...
                <path d="M47 62V55V52C47 49.7909 45.2091 48 43 48V48C40.7909 48 39 49.7909 39 52V55V62" stroke="#4C73A8" strokeWidth="2.5" />
          ...
          <div className="max-w-[85%]" style={{ marginLeft: '8%' }}>
            <div className="grid items-start">
              ...
              <div className="grid grid-cols-2 grid-rows-2 gap-[20px] sm:w-fit">
                <div className="flex flex-col items-center bg-[#20446F]/80 sm:w-[300px] 2xl:h-[234px] rounded-[10px] gap-[20px] justify-center p-4 text-center h-[135px] sm:h-[auto]">
