    ...
    <>
      <div className="relative mx-auto h-[390px] sm:h-[500px] md:h-[100vh] w-[100vw]  text-center pt-[70px] md:pt-[150px]">
        <div className="relative mx-auto top-[30%] max-w-[85%]">
          <h2 className='absolute  z-10 left-0 text-left  uppercase font-bold text-white sm:leading-[50px] xl:leading-[56px] text-[22px] xl:text-[46px] 2xl:text-[80px] 2xl:leading-[90px]' dangerouslySetInnerHTML={{ __html: real_estate_services_title}}></h2>
        </div>
      ...
      <div className="mx-auto max-w-[85%] mb-[20%] sm:mb-[5%] 2xl:mb-[203px]">
        <div className='grid grid-cols-1 sm:grid-cols-2 items-center mb-[5%] 2xl:mb-[150px]'>
          <div className='mt-[100px] sm:w-[83%] 2xl:sm:w-[100%] order-1 sm:order-0'>
            <h3 className='text-yellow-1 text-[22px] sm:text-[28px] 2xl:text-[45px] font-bold mb-[35px]' dangerouslySetInnerHTML={{ __html: real_estate_services_1 }}></h3>
            <div className='text-[13px] text-gray-5 mb-[15px]'>{real_estate_services_2} </div>
        ...
        <div>
          <h3 className='text-yellow-1 text-[22px] sm:text-[28px] 2xl:text-[45px] font-bold text-center uppercase mb-[5%] 2xl:mb-[117px] mt-[20%] sm:mt-[10%]' dangerouslySetInnerHTML={{ __html: real_estate_services_4 }}></h3>
          <div className="flex overflow-x-scroll md:overflow-x-visible  md:grid md:grid-cols-3">
            <div className="grow-1 relative flex-shrink-0 w-[95%] md:w-auto flex  flex-col justify-center items-center gap-[35px] group">
              <svg height="110" viewBox="0 0 113 112" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M24 31L61.73 10L101 31" stroke="#4C73A8" strokeWidth="2.5" strokeLinecap="round" className="group-hover:stroke-yellow-1 transition-colors duration-300" />
                <path d="M37 25V69H86V25" stroke="#4C73A8" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" className="group-hover:stroke-yellow-1 transition-colors duration-300" />
                <path d="M70 69V56.5V52C70 47.5817 66.4183 44 62 44V44C57.5817 44 54 47.5817 54 52V56.5V69" stroke="#4C73A8" strokeWidth="2.5" className="group-hover:stroke-yellow-1 transition-colors duration-300" />
                <path d="M46 10L46 19" stroke="#4C73A8" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" className="group-hover:stroke-yellow-1 transition-colors duration-300" />
                <path d="M46 9C43.7909 9 42 7.20914 42 5C42 2.79086 43.7909 1 46 1C48.2091 1 50 2.79086 50 5C50 7.20914 48.2091 9 46 9Z" stroke="#4C73A8" strokeWidth="2" className="group-hover:stroke-yellow-1 transition-colors duration-300" />
              ...
              <h4 className='text-yellow-1 uppercase font-bold text-[18px] 2xl:text-[22px]'>{real_estate_services_5}</h4>
            </div>
            <div className="grow-1 relative flex-shrink-0 w-[95%] md:w-auto flex 
            flex-col justify-center items-center gap-[35px]
            after:content-['']
            ...
            group
            ">
              <svg height="110" viewBox="0 0 110 111" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path className="group-hover:stroke-yellow-1 transition-colors duration-300" d="M31.0234 15L55.5234 2L81.0234 15" stroke="#4C73A8" strokeWidth="2.5" strokeLinecap="round" />
                <path className="group-hover:stroke-yellow-1 transition-colors duration-300" d="M39.5234 11V38.5H72.0234V11" stroke="#4C73A8" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                <path className="group-hover:stroke-yellow-1 transition-colors duration-300" d="M96.5 13.5H103.023C104.523 13.3333 107.523 14 107.523 18V81.5C107.523 89.5 101.023 89 101.023 89H8.02294C6.02294 89.3333 2.02294 89 2.02294 85V18.5C1.85627 16.8333 2.52294 13.5 6.52294 13.5H15.5" stroke="#4C73A8" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
                <path className="group-hover:stroke-yellow-1 transition-colors duration-300" d="M2.52344 74H26.0234" stroke="#4C73A8" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                <path className="group-hover:stroke-yellow-1 transition-colors duration-300" d="M38.5234 74H107.523" stroke="#4C73A8" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                <path className="group-hover:stroke-yellow-1 transition-colors duration-300" d="M11.0234 73.5V23.5H39.0234M72.5234 23.5H98.0234V73.5" stroke="#4C73A8" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                <path className="group-hover:stroke-yellow-1 transition-colors duration-300" d="M22.5234 109H84.5234" stroke="#4C73A8" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
                <path className="group-hover:stroke-yellow-1 transition-colors duration-300" d="M63.5234 89L71.5234 109" stroke="#4C73A8" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                <path className="group-hover:stroke-yellow-1 transition-colors duration-300" d="M43.5234 89L35.5234 109" stroke="#4C73A8" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                <path className="group-hover:stroke-yellow-1 transition-colors duration-300" d="M19.0234 50.5H44.0234" stroke="#4C73A8" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                <path className="group-hover:stroke-yellow-1 transition-colors duration-300" d="M19.0234 58H44.0234" stroke="#4C73A8" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                <path className="group-hover:stroke-yellow-1 transition-colors duration-300" d="M20 65H81" stroke="#4C73A8" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                <path className="group-hover:stroke-yellow-1 transition-colors duration-300" d="M61.5234 39V30.5V27.5C61.5234 24.4624 59.061 22 56.0234 22V22C52.9859 22 50.5234 24.4624 50.5234 27.5V30.5V39" stroke="#4C73A8" strokeWidth="2.5" />
                <circle className="group-hover:stroke-yellow-1 transition-colors duration-300" cx="53.0234" cy="80.5" r="1.25" stroke="#4C73A8" strokeWidth="2.5" />
                <path className="group-hover:stroke-yellow-1 transition-colors duration-300" d="M88.5234 40H84.5234V44H80.5234V49.5H86.5234V54H83.0234" stroke="#4C73A8" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                <circle className="group-hover:stroke-yellow-1 transition-colors duration-300" cx="21" cy="13" r="4" stroke="#4C73A8" strokeWidth="2" />
                <circle className="group-hover:stroke-yellow-1 transition-colors duration-300" cx="91" cy="14" r="4" stroke="#4C73A8" strokeWidth="2" />
                <circle className="group-hover:stroke-yellow-1 transition-colors duration-300" cx="86" cy="65" r="4" stroke="#4C73A8" strokeWidth="2" />
              </svg>
              <h4 className='text-yellow-1 uppercase font-bold text-[18px] 2xl:text-[24px]'>{real_estate_services_6}</h4>
            </div>
            <div className="grow-1 relative flex-shrink-0 w-[95%] md:w-auto flex  flex-col justify-center items-center gap-[35px] group">
              <svg height="110" viewBox="0 0 114 114" fill="none" xmlns="http://www.w3.org/2000/svg">
                <mask id="path-1-inside-1_1_2377" fill="white">
                  <rect x="18" y="22" width="75" height="92" rx="3" />
                </mask>
                <rect className="group-hover:stroke-yellow-1 transition-colors duration-300" x="18" y="22" width="75" height="92" rx="3" stroke="#4C73A8" strokeWidth="8" strokeLinejoin="round" mask="url(#path-1-inside-1_1_2377)" />
                <path className="group-hover:stroke-yellow-1 transition-colors duration-300" d="M33 23V15C33 13.3431 34.3431 12 36 12H99C100.657 12 102 13.3431 102 15V97C102 98.6569 100.657 100 99 100H91.5" stroke="#4C73A8" strokeWidth="2.5" strokeLinejoin="round" />
                <path className="group-hover:stroke-yellow-1 transition-colors duration-300" d="M43 13V5C43 3.34315 44.3431 2 46 2H109C110.657 2 112 3.34315 112 5V87C112 88.6569 110.657 90 109 90H101.5" stroke="#4C73A8" strokeWidth="2.5" strokeLinejoin="round" />
                <path className="group-hover:stroke-yellow-1 transition-colors duration-300" d="M26 42L42.66 31L60 42" stroke="#4C73A8" strokeWidth="2.5" strokeLinecap="round" />
                <path className="group-hover:stroke-yellow-1 transition-colors duration-300" d="M31 39V62H55V39" stroke="#4C73A8" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                <path className="group-hover:stroke-yellow-1 transition-colors duration-300" d="M47 62V55V52C47 49.7909 45.2091 48 43 48V48C40.7909 48 39 49.7909 39 52V55V62" stroke="#4C73A8" strokeWidth="2.5" />
                <path className="group-hover:stroke-yellow-1 transition-colors duration-300" d="M65 37H82" stroke="#4C73A8" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                <path className="group-hover:stroke-yellow-1 transition-colors duration-300" d="M65 44H82" stroke="#4C73A8" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                <path className="group-hover:stroke-yellow-1 transition-colors duration-300" d="M65 51H82" stroke="#4C73A8" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                <path className="group-hover:stroke-yellow-1 transition-colors duration-300" d="M65 58H82" stroke="#4C73A8" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                <path className="group-hover:stroke-yellow-1 transition-colors duration-300" d="M29 80H43" stroke="#4C73A8" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                <path className="group-hover:stroke-yellow-1 transition-colors duration-300" d="M67 87H81" stroke="#4C73A8" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                <path className="group-hover:stroke-yellow-1 transition-colors duration-300" d="M54 80L81 80" stroke="#4C73A8" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                <path className="group-hover:stroke-yellow-1 transition-colors duration-300" d="M29 87L56 87" stroke="#4C73A8" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                <circle className="group-hover:stroke-yellow-1 transition-colors duration-300" cx="31" cy="97" r="4" stroke="#4C73A8" strokeWidth="2" />
                <circle className="group-hover:stroke-yellow-1 transition-colors duration-300" cx="78" cy="71" r="4" stroke="#4C73A8" strokeWidth="2" />
                <circle className="group-hover:stroke-yellow-1 transition-colors duration-300" cx="7" cy="101" r="4" stroke="#4C73A8" strokeWidth="2" />
                <circle className="group-hover:stroke-yellow-1 transition-colors duration-300" cx="24" cy="7" r="4" stroke="#4C73A8" strokeWidth="2" />
                <path className="group-hover:stroke-yellow-1 transition-colors duration-300" d="M29 71H73" stroke="#4C73A8" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                <path className="group-hover:stroke-yellow-1 transition-colors duration-300" d="M36 97L81 97" stroke="#4C73A8" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                <path className="group-hover:stroke-yellow-1 transition-colors duration-300" d="M2 42H11.5" stroke="#4C73A8" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                <path className="group-hover:stroke-yellow-1 transition-colors duration-300" d="M7 30.25C9.62335 30.25 11.75 32.3766 11.75 35V78.7041C11.75 79.3517 11.669 79.9964 11.5088 80.623L11.4355 80.8906L7.08301 95.6875C7.07218 95.7243 7.03836 95.75 7 95.75C6.97107 95.75 6.94455 95.7358 6.92871 95.7129L6.91699 95.6875L2.56445 80.8906C2.35564 80.1806 2.25002 79.4442 2.25 78.7041V35C2.25 32.3766 4.37665 30.25 7 30.25Z" stroke="#4C73A8" strokeWidth="2.5" />
              </svg>
        ...
        <div className='flex items-center bg-[url(/fecosystem/detail/operation-6.png)] bg-cover bg-center sm:h-[100vh] h-[60vh]'>
          <div className="max-w-[85%]" style={{ marginLeft: '8%' }}>
            <div className="grid items-start">
              <h3 className='text-yellow-1 text-[22px] sm:text-[28px] 2xl:text-[45px] font-bold uppercase mb-[60px] mt-8' dangerouslySetInnerHTML={{ __html: real_estate_services_8 }}></h3>
              <div className="grid grid-cols-2 grid-rows-2 gap-[20px] sm:w-fit">
                <div className="flex flex-col items-center bg-[#20446F]/80 sm:w-[300px] 2xl:h-[234px] rounded-[10px] gap-[20px] justify-center p-4 text-center h-[135px] sm:h-[auto] hover:bg-[#20446F] transition-all duration-300">
                  <svg className='2xl:w-[auto] 2xl:h-[auto]' width="99" height="91" viewBox="0 0 99 91" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M59.8661 33.6831C61.4489 33.6831 62.7321 32.4109 62.7321 30.8415C62.7321 29.2722 61.4489 28 59.8661 28C58.2832 28 57 29.2722 57 30.8415C57 32.4109 58.2832 33.6831 59.8661 33.6831Z" stroke="white" strokeWidth="2" strokeMiterlimit="10" />
                    <path d="M78.3833 68.7269C87.9537 68.7269 95.712 61.035 95.712 51.5465C95.712 42.0581 87.9537 34.3662 78.3833 34.3662C68.813 34.3662 61.0547 42.0581 61.0547 51.5465C61.0547 61.035 68.813 68.7269 78.3833 68.7269Z" stroke="white" strokeWidth="2" strokeMiterlimit="10" />
                    <path d="M87.2024 66.3008L96.7706 80.2134L88.8449 78.574L86.1166 87.3226L79.0176 68.9183" stroke="white" strokeWidth="2" strokeMiterlimit="10" />
                    <path d="M70.1175 66.8472L61.9492 81.3062L69.3293 78.5739L72.0576 87.3226L79.1511 68.9182" stroke="white" strokeWidth="2" strokeMiterlimit="10" />
                ...
                <div className="flex flex-col items-center bg-[#20446F]/80 sm:w-[300px] 2xl:h-[234px] rounded-[10px] gap-[20px] justify-center p-4 text-center h-[135px] sm:h-[auto] hover:bg-[#20446F] transition-all duration-300">
                  <svg className='2xl:w-[auto] 2xl:h-[auto]' width="70" height="70" viewBox="0 0 97 87" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M21.4082 81.8276L25.0931 74.7181C26.2979 72.3925 28.2427 70.5375 30.6182 69.4464L39.5339 65.3535" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M45.7188 85.4651L47.9578 74.0338C48.026 73.6829 47.9514 73.317 47.7488 73.0218L46.1431 70.679C45.964 70.4159 46.1495 70.0586 46.4672 70.0586H52.2568C52.566 70.0586 52.7558 70.4009 52.5916 70.6641L51.0904 73.0731C50.9262 73.3384 50.8579 73.6508 50.9006 73.961L52.5404 85.8909" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M73.0331 33.1673L73.402 35.2897C73.4596 35.617 73.6835 35.8888 73.9927 36.0064L74.498 36.1968C74.498 36.1968 75.882 40.3603 79.4026 40.8652C79.4026 40.8652 82.2942 40.9915 84.1814 36.0706L84.5418 35.8909C84.7913 35.7647 84.9726 35.5336 85.0344 35.2619L85.5057 33.1802C85.5419 33.0218 85.4758 32.8571 85.3415 32.7672L85.1773 32.6581C84.9491 32.5062 84.8105 32.2473 84.8105 31.9713V31.0257C84.8105 31.0257 86.9472 26.9885 83.6782 26.3573C83.6782 26.3573 82.6717 23.3299 78.7736 23.9611C78.7736 23.9611 72.9883 24.9709 72.9883 29.3868L73.3657 31.4065L73.515 31.8023C73.6493 32.1618 73.5193 32.5661 73.2015 32.7779C73.0736 32.8635 73.0075 33.0176 73.0331 33.1716V33.1673Z" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M95.8753 49.9496L93.7023 45.7584C92.9922 44.3869 91.845 43.2937 90.444 42.6497L85.1875 40.2363" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M65.2266 45.7559C65.9367 44.3845 67.0839 43.2912 68.4849 42.6472L73.7414 40.2339" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M77.3906 52.0931L78.7106 45.3515C78.7511 45.144 78.7063 44.9301 78.5869 44.7546L77.6401 43.3746C77.5335 43.2206 77.6444 43.0088 77.832 43.0088H81.2461C81.4295 43.0088 81.5403 43.2099 81.4423 43.3661L80.5573 44.7867C80.4592 44.9429 80.4208 45.1269 80.4464 45.3109L81.4145 52.3455" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M10.9803 33.1673L11.3492 35.2897C11.4068 35.617 11.6307 35.8888 11.9399 36.0064L12.4453 36.1968C12.4453 36.1968 13.8293 40.3603 17.3499 40.8652C17.3499 40.8652 20.2415 40.9915 22.1287 36.0706L22.4891 35.8909C22.7386 35.7647 22.9198 35.5336 22.9817 35.2619L23.4529 33.1802C23.4892 33.0218 23.4231 32.8571 23.2887 32.7672L23.1245 32.6581C22.8964 32.5062 22.7578 32.2473 22.7578 31.9713V31.0257C22.7578 31.0257 24.8945 26.9885 21.6254 26.3573C21.6254 26.3573 20.6189 23.3299 16.7208 23.9611C16.7208 23.9611 10.9355 24.9709 10.9355 29.3868L11.313 31.4065L11.4623 31.8023C11.5966 32.1618 11.4665 32.5661 11.1488 32.7779C11.0208 32.8635 10.9547 33.0176 10.9803 33.1716V33.1673Z" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M31.6496 45.7559C30.9395 44.3845 29.7922 43.2912 28.3912 42.6472L23.1348 40.2339" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M1 49.9496L3.17295 45.7584C3.88305 44.3869 5.0303 43.2937 6.43131 42.6497L11.6878 40.2363" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M15.3359 52.0931L16.6559 45.3515C16.6964 45.144 16.6517 44.9301 16.5322 44.7546L15.5854 43.3746C15.4788 43.2206 15.5897 43.0088 15.7774 43.0088H19.1914C19.3748 43.0088 19.4857 43.2099 19.3876 43.3661L18.5026 44.7867C18.4045 44.9429 18.3661 45.1269 18.3917 45.3109L19.3598 52.3455" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M39.8738 2.48242C40.1744 2.20754 40.5713 2.0542 40.9837 2.0542H60.4182C60.8845 2.0542 61.3277 2.24868 61.6341 2.58901L68.4591 10.1362C69.0179 10.7552 69.0179 11.679 68.4591 12.2961L51.0613 31.5437C50.5853 32.071 49.7414 32.0766 49.2577 31.5568L31.4283 12.4082C30.8117 11.7463 30.8541 10.729 31.5227 10.1175L32.9375 9" stroke="white" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M55.7829 7.77002L59.8613 12.0892L51.8613 21.77" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M44.43 7.77002L40.8613 12.0892L47.8613 21.77" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M50.9375 12L57.9375 12" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                ...
                <div className="flex flex-col items-center bg-[#20446F]/80 sm:w-[300px] 2xl:h-[234px] rounded-[10px] gap-[20px] justify-center p-4 text-center h-[135px] sm:h-[auto] hover:bg-[#20446F] transition-all duration-300">
                  <svg className='2xl:w-[auto] 2xl:h-[auto]' width="70" height="90" viewBox="0 0 70 90" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <circle cx="18.4668" cy="17.5" r="1.5" stroke="white" strokeWidth="2" />
                    <circle cx="43.9668" cy="3" r="2" stroke="white" strokeWidth="2" />
                    <circle cx="67.4668" cy="19.5" r="1.5" stroke="white" strokeWidth="2" />
                    <path d="M39.0702 63L39.0702 58.7936C39.0702 58.7936 36.5954 57.8893 36.7319 53.8291C36.8388 50.6591 35.7358 46.2674 34.5315 44.3149C32.9726 41.7868 24.8603 35.5823 29.2597 25.4713C33.2582 16.2844 42.9195 17.0138 42.9195 17.0138H42.0135C42.0135 17.0138 51.6748 16.283 55.6733 25.4713C60.0742 35.5823 51.9604 41.7882 50.4016 44.3149C49.1986 46.2674 48.0942 50.6591 48.2011 53.8291C48.339 57.8893 45.8628 58.7936 45.8628 58.7936H42.9196" stroke="white" strokeWidth="2" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M61.9668 33H68.9668" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M59.9668 23L65.9668 20" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M53.9668 15L56.9668 10" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M43.9668 12V6" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M33.9668 14L30.9668 9" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M25.9668 21L20.9668 18" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M23.9668 31H16.9668" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M35.7871 38L38.9522 33.7771C38.9522 33.7771 42.0021 35.1298 43.8226 32.562C43.8226 32.562 47.8133 35.5294 49.5311 31.0905C49.5311 31.0905 52.8766 31.4024 52.9668 27.795C52.9668 27.795 51.9719 24.2768 48.5362 25.5081C48.5362 25.5081 48.1588 21.6591 43.9628 22.8363C43.9628 22.8363 40.67 20.6709 38.1391 23.3089C38.1391 23.3089 34.251 23.4844 34.6132 27.0917C34.6132 27.0917 31.4786 28.1474 33.8597 31.6656C33.8597 31.6656 34.3038 32.4567 35.2265 32.8968L35.7885 37.9987L35.7871 38Z" stroke="white" strokeWidth="2" strokeMiterlimit="10" strokeLinejoin="round" />
                    <path d="M36.9668 49H48.9668" stroke="white" strokeWidth="2" strokeMiterlimit="10" />
