      ...
      <div className="mx-auto max-w-[85%] mb-[5%] 2xl:mb-[203px]">
        <div className='grid grid-cols-1 sm:grid-cols-2 items-center mb-[5%] 2xl:mb-[150px]'>
          <div className='mt-[200px] w-[81%] order-1 sm:order-0'>
            <h3 className='text-yellow-1 text-[24px] xl:text-[28px] font-bold mb-[35px]'>KẾT NỐI TRỰC TIẾP <br /> ĐỒNG HÀNH CHUYÊN NGHIỆP</h3>
            <p className='text-[14px] text-gray-5 mb-[18px]'>Đóng vai trò cầu nối chiến lược, Dịch vụ Bất động sản của Pi Group mang sản phẩm chất lượng đến với đúng khách hàng và nhà đầu tư mục tiêu. Trong đó, Công ty Cổ phần ECOE Việt Nam là thành viên chủ lực trong hệ sinh thái toàn diện của Pi Group. </p>
            <p className='text-[14px] text-gray-5'>Bằng sự am hiểu thị trường sâu sắc, mạng lưới rộng khắp và đội ngũ chuyên gia tận tâm, ECOE Việt Nam cung cấp các giải pháp tiếp thị, phân phối và tư vấn toàn diện, đảm bảo sự thành công cho mọi giao dịch.</p>
          </div>
        ...
        <div>
          <h3 className='text-yellow-1 text-[24px] xl:text-[28px] font-bold text-center uppercase mb-[5%] 2xl:mb-[117px]' style={{ marginTop: '10%' }}>Trao Bất động sản thực <br /> đến đúng nhu cầu từng khách hàng</h3>
        ...
        <div className='flex items-center bg-[url(/fecosystem/detail/operation-6.png)] bg-cover bg-center h-[100vh]'>
          <div className="max-w-[85%]" style={{ marginLeft: '10%' }}>
            <div className="grid items-start">
              <h3 className='text-yellow-1 text-[24px] xl:text-[40px] font-bold uppercase mb-[60px] mt-8'>Định vị tổ ấm <br /> Kiến tạo tương lai</h3>
              <div className="grid grid-cols-2 grid-rows-2 gap-[20px] sm:w-fit">
                <div className="flex flex-col items-center bg-[#20446F] bg-opacity-80 sm:w-[300px] 2xl:h-[234px] rounded-[10px] gap-[20px] justify-center">
                  <svg width="80" height="80" viewBox="0 0 99 91" fill="none" xmlns="http://www.w3.org/2000/svg">
