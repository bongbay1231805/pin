...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      "fixed inset-0 z-50 bg-[#EAF3FF] data-[state=closed]:animate-slide-out-to-left data-[state=open]:animate-slide-in-from-left",
      className
    )}
    {...props}
    ref={ref}
...
const sheetVariants = cva(
  "fixed z-50 gap-4  p-6 transition duration-1500  ease-in-out data-[state=closed]:duration-1500 data-[state=open]:duration-1500 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
        ...
        left: "inset-y-0 left-0 h-full w-3/4  data-[state=closed]:animate-slide-out-to-left data-[state=open]:slide-in-from-left",
        right:
