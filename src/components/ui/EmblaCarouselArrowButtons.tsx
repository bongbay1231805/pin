...
export const PrevButton: React.FC<PropType> = (props) => {
  ...
  return (
    <button
      className={`w-[27px] h-[27px] ${styles.embla__button}`}
      type="button"
      {...restProps}
    >
      <svg className='hover:bg-yellow-1 rounded-full text-white hover:[&>g>circle]:text-yellow-1' width="27" height="27" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
