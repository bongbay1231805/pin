...
export function ContentBidding({post}:any) {
  ...
  return (
    <>
      ...
      <div className="text-gray-5 text-[13px] 2xl:text-[17px] pt-[47px] [&>img]:my-[30px] [&>figure>img]:my-[30px] [&>figure]:text-center [&>figure]:text-[17px] [&>figure]:text-gray-6 [&>figure]:mb-[8px] sm:[&>figure]:mb-[20px] post-content [&>figure>figcaption]:text-[13px]" dangerouslySetInnerHTML={{ __html: post.content }}></div>
      <div>
        ...
        <ul className="flex gap-[10px] mt-[86px] mb-[45px] items-center justify-end">
          ...
          <li>
            <a href={`https://www.instagram.com/p?https://pigroup.vn/${post.slug}`}>
              <Image
                src="/fnews/inter.svg"
                alt="Modern cityscape with high-rise buildings"
                width={32}
          ...
          <li>
            <a href={`http://www.linkedin.com/shareArticle?url=https://pigroup.vn/${post.slug}`}>
              <Image
