...
export function ContentBidding({post}:any) {
  ...
  return (
    <>
      <div className="flex items-center gap-[20px] sm:gap-[40px] border-b-[2px] border-[#D9D9D9] pt-[70px]">
        ...
        <h1 className="uppercase text-[20px] xl:text-[39px] text-blue-1 font-bold">{post.name}</h1>
      </div>
