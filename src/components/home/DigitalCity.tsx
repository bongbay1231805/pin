...
const DigitalCity = forwardRef<HTMLDivElement>((props, ref) => {
  return (
    <>
      <div className="mx-auto max-w-[95%] md:max-w-[85%]  2xl:max-w-[1580px]" ref={ref}>
        <div className="relative mx-auto flex items-center justify-center">
          <div className="text-center max-w-[1090px]">
            ...
            <h2 className="text-size-25 2xl:text-[45px] font-bold text-yellow-1 -mt-[3px] fade-in-left-short">ĐÔ THỊ SỐ TIỆN ÍCH 5★</h2>
            <p className="text-[20px] 2xl:text-[28px] mb-[37px] text-gray-1 -mt-[8px] fade-in-left-short">CHUẨN QUỐC TẾ</p>
            <p className="text-[14px] 2xl:text-[17px] mb-[35px] md:mb-[42px] text-gray-5 leading-[28px] fade-in-left-short">
