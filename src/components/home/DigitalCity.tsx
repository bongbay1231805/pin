...
const DigitalCity = forwardRef<HTMLDivElement>((props, ref) => {
  return (
    <>
      <div className="mx-auto max-w-[56%] xl:max-w-[1058px]" ref={ref}>
        <div className="relative mx-auto flex items-center justify-center">
          <div className="text-center max-w-[1090px]">
            <p className="text-[28px] mt-[71px] text-gray-1 fade-in-left-short">NHÀ PHÁT TRIỂN</p>
            <h2 className="text-[45px] font-bold text-yellow-1 -mt-[3px] fade-in-left-short">ĐÔ THỊ SỐ TIỆN ÍCH 5★</h2>
            <p className="text-[28px] mb-[37px] text-gray-1 -mt-[8px] fade-in-left-short">CHUẨN QUỐC TẾ</p>
            <p className="text-[17px] mb-[35px] md:mb-[42px] text-gray-5 leading-[28px] fade-in-left-short">
