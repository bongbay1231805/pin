        ...
        <div className="mx-auto mb-[42px] mt-[15px] max-w-[85%] boxanimation fade-in-up-medium">
          <div className="grid grid-cols-1 sm:grid-cols-[50%_50%] items-center">
            ...
            <div className="mt-[40px] 2xl:mt-68px] md:pl-[46px] md:pr-[46px] text-center sm:text-left fade-in-left-short">
              ...
              />
              <div
                className="text-gray-5 leading-[22px] font-normal mb-[35px] [&>p]:mb-[15px] [&>p]::last:mb-[30px] text-center sm:reveal-text sm:text-justify text-[13px] 2xl:text-[17px]"
                dangerouslySetInnerHTML={{__html: field_8}}
              ></div>
              <div className="grid justify-center mb-[20px] sm:mb-0 sm:justify-start">
                <Link
                  href={`${field_10}`}
                  className="reveal-text hvr-bounce-to-right flex items-center justify-center text-yellow-1 text-[13px] font-semibold w-[138px] h-[30px] border border-yellow-1 hover:text-white active:text-white"
                >
                  {field_9}
                </Link>
              </div>
