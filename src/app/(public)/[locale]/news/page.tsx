        ...
        <div className="mx-autoflex flex-col gap-12">
          ...
          <Link href="/news/market-news" className="relative news-top-item">
            ...
            <div className="absolute bottom-0 right-0 translate-y-1/4 z-10 8 max-w-[calc(52%_-_15px)] bg-[#142F4F] rounded-tr-[40px] text-white pl-10 pr-11 py-6 shadow-xl">
              ...
              <div className="text-[14px] 2xl:text-[17px] text-white/85">
          ...
          <div className="grid mt-[120px] 2xl:mt-[130px] grid-cols-1 gap-y-[10px] gap-x-[10px] sm:grid-cols-2 sm:gap-y-[50px] sm:gap-x-[40px]">
              ...
              <Link href="/news/market-news" className="news-item relative rounded-2xl flex flex-col">
                ...
                {/* Label */}
                <div >
                  <div className="title absolute bottom-[56px] left-0 translate-y-2/5 leading-[21px] 2xl:leading-[26px] z-10 bg-[#EAF3FF] rounded-tr-[60px] w-[72%] px-5 py-[22px] text-blue-1 font-bold text-[15px] 2xl:text-[17px] uppercase">
              ...
              <Link href="/news/market-news" className="news-item relative rounded-2xl flex flex-col">
                ...
                {/* Label */}
                <div >
                  <div className="title absolute bottom-0 left-0 translate-y-2/5 leading-[21px] 2xl:leading-[26px] z-10 bg-[#EAF3FF] rounded-tr-[60px] w-[72%] px-5 py-[22px] text-blue-1 font-bold text-[15px] 2xl:text-[17px] uppercase">
                    KHỞI CÔNG DÒNG SẢN PHẨM CĂN PICITY CỦA NGÕ TP THỦ ĐỨC
                  </div>
                </div>
              </Link> 
