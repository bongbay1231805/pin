...
export default async function Digitalcity() {
  ...
  return (
    <>
      <div className="relative mx-auto h-[320px] md:h-[500px] md:h-[100vh] w-[100vw]  text-center pt-[20%] md:pt-[106px]">
        <div className="relative mx-auto md:top-[30%] max-w-[85%]">
          ...
          <h2 className='absolute z-10 left-0 text-left  uppercase font-bold text-white text-[14px] md:text-[30px] flex items-center gap-[12px]'>
            <div className='leading-[48px]'>{digitalcity_1} <br /> {digitalcity_2}</div>
            <svg width="166" height="85" viewBox="0 0 166 85" fill="none" xmlns="http://www.w3.org/2000/svg" className='w-[25%] md:w-[auto]'>
