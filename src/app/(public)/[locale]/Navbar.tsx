...
const Navbar = () => {
  ...
  return (
    <nav id="topMenu" className={`absolute top-0 left-0 w-full z-50 transition-all duration-300 border-white-1 ${pathname === "ecosystem" ? 'border-b-[1px]!' : ""} ${(hasShadow) ? 'bg-white border-b-[1px] fixed text-yellow-1' : isHomePage ? "bg-transparent text-white" : "bg-white text-yellow-1"}`}>
      <div className={`mx-auto ${(hasShadow ? 'max-w-[85%]' : isHomePage ? 'max-w-[91.4%]' : 'max-w-[85%]')}`}>
        <div className={`flex justify-between ${(hasShadow ? 'h-[70px]' : isHomePage ? 'h-[106px]' : 'h-[70px]')}`}>
          <div className="flex items-center">
            <Link href="/" className={`flex-shrink-0 flex items-center text-yellow-1 ${(hasShadow) ? 'text-yellow-1' : isHomePage ? 'text-white!' : ''}`}>
              {/* <svg className={`${(pathname === 'investment-development' || pathname === 'real-estate-services' || pathname === 'management-operation') ? "text-yellow-1 " : ""} ${(hasShadow) ? 'h-[60px]' : isHomePage ? 'w-[60px] h-[60px] md:w-[80px] md:h-[80px]' : 'w-[60px] h-[60px]'}`} width="60" height="60" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <svg className={`${(pathname === 'investment-development' || pathname === 'real-estate-services' || pathname === 'management-operation') ? "text-yellow-1 " : ""} ${(hasShadow) ? 'h-[60px]' : isHomePage ? 'w-[60px] h-[60px] md:w-[80px] md:h-[80px]' : 'w-[60px] h-[60px]'}`}
                xmlns="http://www.w3.org/2000/svg" width="61" height="60" viewBox="0 0 61 60" fill="none">
                <path d="M22.1209 7.03597L18.0584 0C10.6097 4.30142 6.02045 12.2498 6.02045 20.8527C6.02045 34.1507 16.8011 44.9314 30.0991 44.9314C40.3095 44.9314 49.0373 38.5743 52.5376 29.6021C53.5966 26.8893 54.1778 23.9375 54.1778 20.8527C54.1778 12.2498 49.5885 4.30142 42.1371 0L38.0746 7.03597C42.8431 9.79497 46.0502 14.9491 46.0502 20.8527C46.0502 29.6646 38.9083 36.8065 30.0991 36.8065C21.2899 36.8065 14.148 29.6646 14.148 20.8527C14.148 14.9491 17.3551 9.79497 22.1236 7.03597" fill="#C48C5E"/>
                <path d="M38.0037 33.6595C42.172 31.0797 44.988 26.523 45.1401 21.2983L32.0214 21.9636L38.0064 33.6595H38.0037Z" fill="#C48C5E"/>
                <path d="M45.1403 20.4071C44.9883 15.1824 42.175 10.6257 38.0039 8.0459L32.0189 19.7417L45.1376 20.4071H45.1403Z" fill="#C48C5E"/>
                <path d="M22.1911 8.0459C18.0228 10.6257 15.2068 15.1824 15.0547 20.4071L28.1734 19.7417L22.1884 8.0459H22.1911Z" fill="#C48C5E"/>
                <path d="M15.0547 21.2983C15.2068 26.523 18.0201 31.0797 22.1911 33.6595L28.1762 21.9636L15.0574 21.2983H15.0547Z" fill="#C48C5E"/>
                <path d="M30.0995 35.9025C32.682 35.9025 35.1124 35.2507 37.236 34.1048L30.0995 23.0742L22.9604 34.1048C25.0839 35.2507 27.5143 35.9025 30.0995 35.9025Z" fill="#C48C5E"/>
                <path d="M37.2357 7.60091C35.1122 6.45495 32.6818 5.80322 30.0993 5.80322C27.5168 5.80322 25.0864 6.45495 22.9629 7.60091L30.0993 18.6315L37.2357 7.60091Z" fill="#C48C5E"/>
                <path d="M0 47.9375V56.9721H2.67752V49.4636H3.85606C4.85809 49.4636 5.33603 49.4691 5.33603 50.4005V51.3509C5.33603 52.2797 4.85538 52.41 3.85606 52.41H3.41071V53.9443H4.18736C6.49828 53.9443 7.88592 53.8574 7.88592 51.5519V50.1995C7.88592 48 6.31634 47.9375 4.18736 47.9402H0V47.9375Z" fill="#C48C5E"/>
                <path d="M12.0429 47.3457C11.7143 47.3457 11.4482 47.0795 11.4482 46.751C11.4482 46.4224 11.7143 46.1562 12.0429 46.1562C12.3715 46.1562 12.6376 46.4224 12.6376 46.751C12.6376 47.0795 12.3715 47.3457 12.0429 47.3457Z" fill="#C48C5E"/>
                <path d="M12.0431 43.3779C10.1802 43.3779 8.67041 44.8905 8.67041 46.7506C8.67041 48.6108 10.1802 50.1233 12.0431 50.1233C13.906 50.1233 15.4131 48.6135 15.4131 46.7506C15.4131 44.8878 13.9032 43.3779 12.0431 43.3779ZM12.0431 49.0697C10.7614 49.0697 9.72404 48.0297 9.72404 46.7506C9.72404 45.4716 10.7614 44.4288 12.0431 44.4288C13.3248 44.4288 14.3622 45.4689 14.3622 46.7506C14.3622 48.0324 13.3248 49.0697 12.0431 49.0697Z" fill="#C48C5E"/>
                <path d="M12.0433 48.212C11.2368 48.212 10.5823 47.5575 10.5823 46.751C10.5823 45.9445 11.2368 45.29 12.0433 45.29C12.8498 45.29 13.5043 45.9445 13.5043 46.751C13.5043 47.5575 12.8498 48.212 12.0433 48.212Z" fill="#C48C5E"/>
                <path d="M9.65106 56.9721H10.8405V51.8451H11.7502V55.818C11.7502 56.6163 12.1032 56.9748 13.0238 56.9748H14.4386V51.8478H15.2261V50.9707H8.86627V51.8478H9.65378V56.9748L9.65106 56.9721Z" fill="#C48C5E"/>
                <path d="M27.0086 56.9719V53.0181C27.0086 52.1138 26.8647 51.8966 25.8464 51.8966H22.9V53.4716H24.3094V55.4377H22.6095C21.268 55.4377 20.8417 55.454 20.8417 54.1858V50.7343C20.8417 49.4607 21.6074 49.4662 22.7588 49.4662H23.7283C24.4425 49.4662 24.657 49.5096 25.2082 49.0045L26.3759 47.9373H22.7072C20.0786 47.9373 18.1234 47.7825 18.1234 50.862V54.0582C18.1234 56.8036 19.5491 56.9747 22.2619 56.9747H27.0086V56.9719Z" fill="#C48C5E"/>
                <path d="M31.253 56.9724V52.9398C31.253 50.58 32.1627 49.4639 34.5388 49.4639H35.3806C35.8232 49.4639 35.9481 49.4069 36.3908 49.0023L37.5584 47.9351H34.7044C32.6053 47.9351 31.0846 48.6139 30.7886 50.8624V50.5556C30.7886 49.7165 30.088 49.4639 29.1484 49.4639H27.6522V50.1781C28.3283 50.2813 28.5238 50.4497 28.5238 51.1557V56.9724H31.2502H31.253Z" fill="#C48C5E"/>
                <path d="M52.3121 50.9653V60H54.9897V52.4915H56.1682C57.1702 52.4915 57.6482 52.4969 57.6482 53.4283V54.3788C57.6482 55.3075 57.1675 55.4378 56.1682 55.4378H55.7228V56.9721H56.4995C58.8104 56.9721 60.198 56.8852 60.198 54.5797V53.2274C60.198 51.0251 58.6285 50.9653 56.4995 50.9681H52.3121V50.9653Z" fill="#C48C5E"/>
                <path d="M51.0036 56.9724V50.9656H48.3261V55.4354H46.819C45.8197 55.4354 45.339 55.3078 45.339 54.3763V50.9629H42.7891V54.5773C42.7891 56.8801 44.1768 56.9697 46.4877 56.9697H51.0009L51.0036 56.9724Z" fill="#C48C5E"/>
                <path d="M37.998 50.9653H36.1948C34.0659 50.9653 32.7108 51.0251 32.7108 53.2247V54.577C32.7108 56.8825 33.8839 56.9694 36.1948 56.9694H37.998C40.3089 56.9694 41.482 56.8825 41.482 54.577V53.2247C41.482 51.0251 40.1297 50.9653 37.998 50.9653ZM38.9321 54.3761C38.9321 55.3048 38.666 55.4351 37.6667 55.4351H36.5234C35.5268 55.4351 35.2607 55.3075 35.2607 54.3761V53.4256C35.2607 52.4942 35.5241 52.3394 36.5234 52.3394H37.6667C38.6687 52.3394 38.9321 52.4942 38.9321 53.4256V54.3761Z" fill="#C48C5E"/>
              </svg>
            </Link>
          </div>
          {/* Desktop Navigation */}
          <div className={`hidden xl:flex text-[13px] 2xl:text-[17px] font-[600] items-center ml-[11.5%] 2xl:ml-[204px] uppercase grow-1 ${(hasShadow) ? 'h-[70px]' : isHomePage ? 'h-[106px]' : 'h-[70px]'}`}>
            <Link href="/about" className={`group relative grow-1 text-center text-white-1 hover:text-yellow-2 ${isActive("about") ? "text-yellow-2!" : "text-white-1"} ${(hasShadow || pageCurent || !isHomePage) ? "text-gray-6!" : ""}`}>
            ...
            <Link href="/ecosystem" className={`group relative grow-1 text-center hover:text-yellow-2 ${(isActive("ecosystem") || isActive("investment-development") || isActive("real-estate-services") || isActive("management-operation")) ? " text-yellow-2!" : "text-white-1"} ${(hasShadow || pageCurent || !isHomePage) ? "text-gray-6!" : ""}`}>
            ...
            <Link href="/digitalcity" className={`group relative grow-1 text-center hover:text-yellow-2 ${isActive("digitalcity") ? " text-yellow-2!" : "text-white-1"} ${(hasShadow || pageCurent || !isHomePage) ? "text-gray-6!" : ""}`}>
            ...
            <Link href="/human-resource" className={`group relative grow-1 text-center hover:text-yellow-2 ${isActive("human-resource") ? " text-yellow-2!" : "text-white-1"} ${(hasShadow || pageCurent || !isHomePage) ? "text-gray-6!" : ""}`}>
            ...
            <Link href="/contact" className={`group relative grow-1 text-center hover:text-yellow-2 ${isActive("contact") ? " text-yellow-2!" : "text-white-1"} ${(hasShadow || pageCurent || !isHomePage) ? "text-gray-6!" : ""}`}>
